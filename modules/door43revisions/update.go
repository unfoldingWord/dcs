...
// UpdateDoor43Revisions generates door43_revision table entries for valid repos/releases that don't have them
func UpdateDoor43Revisions(ctx context.Context) error {
