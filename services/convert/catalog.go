...
func ToCatalogEntry(ctx context.Context, dm *repo.Door43Metadata, repo *api.Repository, release *api.Release) *api.CatalogEntry {
	...
	return &api.CatalogEntry{
		...
		HealthcheckSeverity:      dm.HealthcheckSeverity.String(),
		IsHealthy:                dm.HealthcheckSeverity.IsHealthy(),
		IsHealthyWithoutWarnings: dm.HealthcheckSeverity.IsHealthyWithoutWarnings(),
		HealthcheckURL:           dm.HealthcheckAPIURL(),
	}
}
