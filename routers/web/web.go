...
func registerRoutes(m *web.Route) {
	...
	m.Group("/{username}/{reponame}", func() {
		...
		}, repo.MustBeNotEmpty, reqRepoCodeReader, reqSignIn) // DCS Customizations: requiring login for commit-related web routes
		...
		}, repo.MustBeNotEmpty, context.RepoRef(), reqRepoCodeReader, reqSignIn) // DCS Customizations: requiring login for commit-related web routes
