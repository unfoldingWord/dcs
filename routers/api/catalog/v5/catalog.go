...
func Search(ctx *context.APIContext) {
	// swagger:operation GET /v5/search v5 catalogSearch
	// ---
...
func SearchOwner(ctx *context.APIContext) {
	// swagger:operation GET /v5/search/{owner} v5 catalogSearchOwner
	// ---
...
func SearchRepo(ctx *context.APIContext) {
	// swagger:operation GET /v5/search/{owner}/{repo} v5 catalogSearchRepo
	// ---
...
func GetCatalogMetadata(ctx *context.APIContext) {
	// swagger:operation GET /v5/entry/{owner}/{repo}/{tag}/metadata v5 catalogGetMetadata
	// ---
